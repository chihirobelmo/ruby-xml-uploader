...
Client (Browser/Windows app) Å® Rails (Controllers) Å® Models/Active Storage Å® DB + storage Å® Views/JSON
...
- Suggested scenarios: login Å® upload Å® list Å® download; unauthorized access rejection; API contract tests.
- Run
	- bin/rails test
